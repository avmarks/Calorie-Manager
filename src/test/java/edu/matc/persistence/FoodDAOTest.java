...
public class FoodDAOTest {
    ...
    @Test
    void updateSuccess() {
        String foodName = "celery";
        Food foodToUpdate = (Food)genericDAO.getById(4);
        foodToUpdate.setFoodName(foodName);
        genericDAO.saveOrUpdate(foodToUpdate);
        Food retrievedFood = (Food)genericDAO.getById(4);
