...
- [ ] Add the item table
- [ ] Add the user table
- [ ] Add a jsp to display user and items
- [ ] Add jsp to add an item
...
- [ ] Prepare for Checkpoint 2: Database designed and created, at least one DAO implemented, DAO is unit tested, Log4J is implemented (no System.out.printlns), class design and any other diagrams you plan to use have been created. 
